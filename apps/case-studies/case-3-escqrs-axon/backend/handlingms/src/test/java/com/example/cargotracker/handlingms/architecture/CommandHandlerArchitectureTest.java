 ...
 * いずれかの引数型が {@code *Command} で終わるものは {@link CommandHandler} 必須。
 * IT5 P1（HandlingActivity register/updateStatus の {@code @CommandHandler} 欠落事例）
 * の再発を防ぐ。</p>
 *
 * <p>参考: docs/development/retrospective-5.md P1</p>
 */
@AnalyzeClasses(packages = "com.example.cargotracker.handlingms.domain.model.aggregates")
