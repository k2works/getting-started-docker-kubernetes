package com.example.cargotracker.handlingms.config;
 ...
 *
 * <p>routingms / bookingms と同方針で、Axon 5.1-RC2 の autoconfig が Spring Boot 4 で
 * 機能しないため、必要な Bean をすべて手動で構成する。詳細は routingms 側の同名クラスを参照。</p>
 */
@Configuration
