package com.example.cargotracker.trackingms.config;
 ...
 *
 * <p>handlingms / routingms / bookingms と同方針。Axon 5.1-RC2 の autoconfig が
 * Spring Boot 4 で機能しないため、必要な Bean をすべて手動で構成する。</p>
 */
@Configuration
