...
- **Kibana**（NodePort 30052）: ログの検索・可視化 UI
...
kubectl -n cargo-event port-forward svc/kibana 18081:5601   # → http://localhost:18081/（開くと Discover が表示される）
#   ※ NodePort が localhost に出る環境では http://localhost:30052/ でも可
```
