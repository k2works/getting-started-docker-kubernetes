 ...
 *
 * <p>IT9 H3 解消の理由は {@link HerokuSecurityConfig} および billingms 版 PreAuthFilter Javadoc を参照。
 * Rule of Three（3 ms 以上に同実装が広がった段階）で {@code shared-security} モジュール抽出を
 * 検討する（ADR-0022 起票候補、IT9 M1）。</p>
 */
